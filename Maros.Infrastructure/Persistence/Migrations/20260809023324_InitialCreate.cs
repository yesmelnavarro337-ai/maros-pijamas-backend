        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AccentHex = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CatalogType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsappDefaultMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmailFromName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmailFromAddress = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    NotifyNewQuotation = table.Column<bool>(type: "bit", nullable: false),
                    SeoMetaTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeoMetaDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SeoSocialImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LegalTermsUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LegalPrivacyUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LegalReturnsPolicy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomDomain = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FeaturedHome = table.Column<bool>(type: "bit", nullable: false),
                    AllowCustomization = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    SeoSlug = table.Column<string>(type: "nvarchar(220)", maxLength: 220, nullable: false),
                    SeoSocialImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeoAltText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroSubtitle = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ...
                    ColorPrimary = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ColorAccent = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ...
                    CtaLink = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuotationItemOptions_CustomizationOptions_CustomizationOptionId",
